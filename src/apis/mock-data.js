    ...
    board: {
      ...
      columns: [
          ...
          cards: [
            {
              ...
              cover: 'https://cellphones.com.vn/sforum/wp-content/uploads/2023/08/hinh-nen-desktop-7.jpg',
        ...
        },
        {
          ...
          // Tạo ra card đặc biệt ở front end để giũ chỗ fix lỗi column rỗng card
          // Cấu trúc id của card này Unique rất đơn giản không cần phức tạp
          cardOrderIds: ['card-id-14-placeholderCard'],
          cards: [
            { _id: 'card-id-14-placeholderCard', boardId: 'board-id-01', columnId: 'column-id-04',
